...
namespace lab1 {
    ...
    bool expressionstream::next_token_is_op() {
        ...
        return (*next_position == '+' || *next_position == '-' || *next_position == '*' || *next_position == '/' || *next_position == '^' || *next_position == '%');
    }
    ...
    bool expressionstream::next_token_is_mod() {
        skip_white_space();
        return *next_position == '%';
    }
    bool expressionstream::next_token_is_caret() {
        skip_white_space();
        return *next_position == '^';
    }
