...
TEST_F(Lab06Fixture, append_get_data_get_set_test) {//PASSED
...
TEST_F(Lab06Fixture, insert_remove_test) {//PASSED
...
TEST_F(Lab06Fixture, opEq_insert_append_value_test) {//PASSED
...
TEST_F(Lab06Fixture, split_split_set_test) {//passed
    for (int i = 0; i < 100; ++i) {
        dll_UT->append(i);
    }
...
TEST_F(Lab06Fixture, op_plus_op_plus_eq_test) {//passed
...
TEST_F(Lab06Fixture, compare_op_test) {//passed
    for (int i = 0; i < 100; ++i) {
        dll_UT->append(i);
    }
...
TEST_F(Lab06Fixture, insertion_extraction_op_test) {//passed
