...
TEST_F(Lab02Fixture, stringVector_sort_access_test2) {
    container1 = new lab2::stringVector;

    container1->append("beaa");
    container1->append("Glad");
    container1->append("california");
    container1->append("question");
    container1->append("Bear");
    ...
    EXPECT_EQ("beaa",container1->operator[](0));
    EXPECT_EQ("Bear",container1->operator[](1));
    EXPECT_EQ("california",container1->operator[](2));
    EXPECT_EQ("extra",container1->operator[](3));
    EXPECT_EQ("Glad",container1->operator[](4));
    EXPECT_EQ("question",container1->operator[](5));
    EXPECT_EQ("restful",container1->operator[](6));
}