...
protected:
    virtual void SetUp() {
        ...
        built_tree = new lab8::tree();
        for(auto it = test_numbers.begin(); it<test_numbers.end(); ++it) built_tree->insert(*it);
    }

public:
    lab8::tree *tree, *built_tree;
    std::vector <unsigned> test_numbers;

};
TEST_F(Lab08Fixture, construct_with_check_size) {
    EXPECT_EQ(tree->size(), 0);
    EXPECT_EQ(tree->depth(), 0);
}

TEST_F(Lab08Fixture, depth)
{
...
TEST_F(Lab08Fixture, remove_mult)
{
    built_tree->insert(6);
...
TEST_F(Lab08Fixture, remove_single)
{
    EXPECT_EQ(built_tree->get_frequency(6), 1);
    EXPECT_EQ(built_tree->remove(6), true);
...
TEST_F(Lab08Fixture, remove_nonexistant)
{
    EXPECT_EQ(built_tree->get_frequency(21), 0);
...
TEST_F(Lab08Fixture, remove_parent)
{
    EXPECT_EQ(built_tree->get_frequency(4), 1);
...
TEST_F(Lab08Fixture, remove_root)
{
    EXPECT_EQ(built_tree->get_frequency(12), 1);
...
TEST_F(Lab08Fixture, values_above){
...
TEST_F(Lab08Fixture, equals_operator){
