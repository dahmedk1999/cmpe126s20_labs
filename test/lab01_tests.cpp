...
TEST_F(Lab01Fixture, customtest1) {
    delete stream1;

    stream1 = new lab1::expressionstream("1-1+2-4+2");
...
TEST_F(Lab01Fixture, customtest2) {

    delete stream2;

    stream2 = new lab1::expressionstream("(222-777)-111");

    EXPECT_EQ("(", stream2->get_next_token());
    EXPECT_EQ("222", stream2->get_next_token());
    EXPECT_EQ("-", stream2->get_next_token());
    EXPECT_EQ("777", stream2->get_next_token());
    EXPECT_EQ(")", stream2->get_next_token());
    EXPECT_EQ("-", stream2->get_next_token());
    EXPECT_EQ("111", stream2->get_next_token());

}
TEST_F(Lab01Fixture, customtest3) {

    delete stream3;

    stream3 = new lab1::expressionstream("-1*0");
...
TEST_F(Lab01Fixture, customtest4) {
    delete stream4;

    stream4 = new lab1::expressionstream("5*5*5*5");
...
TEST_F(Lab01Fixture, customtest5) {
    delete stream4;
    stream4 = new lab1::expressionstream("5*(0-50)");
    EXPECT_EQ("5", stream4->get_next_token());
    EXPECT_EQ("*", stream4->get_next_token());
    EXPECT_EQ("(", stream4->get_next_token());
    EXPECT_EQ("0", stream4->get_next_token());
    EXPECT_EQ("-", stream4->get_next_token());
    EXPECT_EQ("50", stream4->get_next_token());
    EXPECT_EQ(")", stream4->get_next_token());
